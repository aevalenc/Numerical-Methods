...
#ifndef EXAMPLES_LINE_CHART_SRC_OPERATORS_GRADIENT_H
#define EXAMPLES_LINE_CHART_SRC_OPERATORS_GRADIENT_H
...
#endif  // EXAMPLES_LINE_CHART_SRC_OPERATORS_GRADIENT_H
