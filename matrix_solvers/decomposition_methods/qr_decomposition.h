...
#ifndef MATRIX_SOLVERS_DECOMPOSITION_METHODS_QR_DECOMPOSITION_H
#define MATRIX_SOLVERS_DECOMPOSITION_METHODS_QR_DECOMPOSITION_H
...
#endif  // MATRIX_SOLVERS_DECOMPOSITION_METHODS_QR_DECOMPOSITION_H
